  ...
  return (
    <div className="space-y-12">
      ...
      <section>
        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed mb-3">
              海外の大学生に混じって、まったく同じ授業を英語で受けました。電磁気学などの工学系理論授業では、日本で学んだ内容でも英語という障壁があり、改めて基礎を問い直す機会になりました。
            </p>
            <p className="text-gray-300 leading-relaxed">
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed">
              現地学生とともに、工学のあり方や産業界との関わりについて議論しました。異なる文化背景を持つ学生と話すと、色々と考えさせられます。
            </p>
          </div>
      ...
      <section>
        ...
        <p className="text-gray-300 leading-relaxed mb-3">
          異なる文化的バックグラウンドを持つ様々な学生たちと交流できたことが、このプログラムで得た最大の財産です。アジアを含む多様な国の学生との対話は、自分の当たり前を問い直すきっかけをたくさん与えてくれました。
        </p>
        <p className="text-gray-300 leading-relaxed mb-3">
